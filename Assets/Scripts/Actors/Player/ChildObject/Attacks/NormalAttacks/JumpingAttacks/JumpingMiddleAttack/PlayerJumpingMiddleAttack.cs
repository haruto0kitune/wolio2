...
namespace Wolio.Actor.Player.Attacks.NormalAttacks.JumpingAttacks
{
    public class PlayerJumpingMiddleAttack : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            HitBox = GameObject.Find("JumpingMiddleAttackHitBox").GetComponent<BoxCollider2D>();
            HurtBox = GameObject.Find("JumpingMiddleAttackHurtBox").GetComponent<BoxCollider2D>();
        }
