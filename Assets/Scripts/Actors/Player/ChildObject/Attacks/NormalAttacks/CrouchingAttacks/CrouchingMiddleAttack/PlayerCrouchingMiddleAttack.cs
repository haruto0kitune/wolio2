...
namespace Wolio.Actor.Player.Attacks.NormalAttacks.CrouchingAttacks
{
    public class PlayerCrouchingMiddleAttack : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            #endregion
            #region CrouchingMiddleAttack->LightFireballMotion
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.CrouchingMiddleAttack"))
            ...
            #endregion
            #region CrouchingMiddleAttack->MiddleFireballMotion
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.CrouchingMiddleAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region CrouchingMiddleAttack->HighFireballMotion
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.CrouchingMiddleAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region CrouchingMiddleAttack->LightDragonPunch
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.CrouchingMiddleAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region CrouchingMiddleAttack->MiddleDragonPunch
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.CrouchingMiddleAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region CrouchingMiddleAttack->HighDragonPunch
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.CrouchingMiddleAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
