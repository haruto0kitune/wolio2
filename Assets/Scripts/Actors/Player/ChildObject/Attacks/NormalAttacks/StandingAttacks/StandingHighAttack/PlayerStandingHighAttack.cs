...
namespace Wolio.Actor.Player.Attacks.NormalAttacks.StandingAttacks
{
    public class PlayerStandingHighAttack : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            #endregion
            #region StandingHighAttack->LightFireballMotion
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.StandingHighAttack"))
            ...
            #endregion
            #region StandingHighAttack->MiddleFireballMotion
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.StandingHighAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region StandingHighAttack->HighFireballMotion
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.StandingHighAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region StandingHighAttack->LightDragonPunch
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.StandingHighAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region StandingHighAttack->MiddleDragonPunch
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.StandingHighAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
            ...
            #endregion
            #region StandingHighAttack->HighDragonPunch
            ObservableStateMachineTrigger
                .OnStateUpdateAsObservable()
                .Where(x => x.StateInfo.IsName("Base Layer.StandingHighAttack"))
                .Where(x => PlayerState.canFireballMotion.Value)
