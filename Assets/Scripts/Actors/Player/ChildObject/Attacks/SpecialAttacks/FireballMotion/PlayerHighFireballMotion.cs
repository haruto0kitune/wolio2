...
{
    public class PlayerHighFireballMotion : MonoBehaviour
    {
        [SerializeField]
        GameObject Player;
        [SerializeField]
        ...
        void Start()
        {
            ...
            ObservableStateMachineTrigger
                ...
                .Where(x => x.StateInfo.IsName("Base Layer.HighFireballMotion"))
            ...
            ObservableStateMachineTrigger
                ...
                .Subscribe(_ =>
                {
                    Animator.SetBool("IsHighFireballMotion", false);
                    Animator.SetBool("IsStanding", true);
                    hasFinished = false;
                    PlayerState.hasInputedHighFireballMotionCommand.Value = false;
                });
            #endregion
