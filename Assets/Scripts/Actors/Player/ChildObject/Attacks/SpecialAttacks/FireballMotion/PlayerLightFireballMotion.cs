...
{
    public class PlayerLightFireballMotion : MonoBehaviour
    {
        [SerializeField]
        GameObject Player;
        [SerializeField]
        ...
        void Start()
        {
            ...
            ObservableStateMachineTrigger
                ...
                .Where(x => x.StateInfo.IsName("Base Layer.LightFireballMotion"))
            ...
            ObservableStateMachineTrigger
                ...
                .Subscribe(_ =>
                {
                    Animator.SetBool("IsLightFireballMotion", false);
                    Animator.SetBool("IsStanding", true);
                    hasFinished = false;
                    PlayerState.hasInputedLightFireballMotionCommand.Value = false;
                });
            #endregion
