...
{
    public class PlayerHighDragonPunch : MonoBehaviour
    {
        [SerializeField]
        GameObject Player;
        ...
        void Start()
        {
            ...
            ObservableStateMachineTrigger
                ...
                .Where(x => x.StateInfo.IsName("Base Layer.HighDragonPunch"))
                .Do(x => Debug.Log("Enter DragonPunch"))
                .Subscribe(_ => coroutineStore = StartCoroutine(HighDragonPunchCoroutine()));
            #endregion
            ...
            ObservableStateMachineTrigger
                ...
                .Subscribe(_ =>
                {
                    Animator.SetBool("IsHighDragonPunch", false);
                    Animator.SetBool("IsStanding", true);
                    hasFinished = false;
                    PlayerState.hasInputedHighDragonPunchCommand.Value = false;
                });
            #endregion
